...
class ProductoDao():
    ...
    def crear_producto(self, producto):
        try:
            ...
            values = (producto.modelo, producto.precio, producto.stock, producto.detalle, producto.marca, producto.estilo, producto.material, producto.color)
    ...
    def editar_producto(self, id_producto, producto):
        try:
            sql = f"UPDATE producto set (modelo, precio, stock, detalle, id_marca, id_estilo, id_material, id_color) VALUES (%s ,%s ,%s ,%s ,%s ,%s ,%s, %s) WHERE id_producto = {id_producto}"
            values = (producto.modelo, producto.precio, producto.stock, producto.detalle, producto.marca, producto.estilo, producto.material, producto.color)
            self.cursor.execute(sql, values)
            self.db.commit()

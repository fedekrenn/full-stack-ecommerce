...
while True:
    ...
    if opcion_elegida == '1':
        ...
        marca = int(input("Ingrese el número de opción para la marca 1:'Specialized', 2:'Scott', 3:'Raleigh', 4:'Venzo':\n"))
        rodado = int(input("Ingrese el número de opción para el rodado 1:'14', 2:'16', 3: '20', 4:'26', 5:'28', 6:'29':\n"))
        estilo = int(input("Ingrese el número de opción para el estilo 1:'Montaña', 2:'Ruta', 3:'Eléctrica', 4:'Niños', 5: 'Urbana':\n"))
        material = int(input("Ingrese el número de opción para el material 1:'Hierro', 2:'Aluminio', 3:'Carbono':\n"))
        color = int(input("Ingrese el número de opción para el color 1:'Rojo', 2:'Azul', 3:'Blanco', 4:'Negro', 5:'Amarillo':\n"))

        producto = Producto(modelo, precio, stock, imagen, detalle, marca, rodado, estilo, material, color)
